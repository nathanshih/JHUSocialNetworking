...
public class InitializeDatabase {
	...
	public void initializeDatabase(DataSource dataSource) {
		...
		if (!isDatabaseInitialized) {
			...
			// configure professor course table
			initializeProfessorCourseTable();
	...
	public void initializeProfessorCourseTable() {
		...
		try {
			...
			// primary key
			sql = "CREATE TABLE ProfessorCourse ("
					+ "professor_course_id int GENERATED BY DEFAULT AS IDENTITY (START WITH 1, INCREMENT BY 1) NOT NULL, "
					+ "course_id varchar(200), " + "professor_id int, "
	 ...
	 */
	public void initializeCartTable() {
		...
		try {
			...
			sql = "CREATE TABLE Cart ("
					+ "cart_id int GENERATED BY DEFAULT AS IDENTITY (START WITH 1, INCREMENT BY 1) NOT NULL, "
					+ "course_id varchar(200), " + "student_id int, "
					+ "PRIMARY KEY (cart_id));";
			conn = dataSource.getConnection();
			ps = conn.prepareStatement(sql);
			ps.execute();
	...
	public void initializeCourseTable() {
		...
		try {
			...
			sql = "CREATE TABLE Course (" + "course_id varchar(200), "
					...
					+ "discipline varchar(1000), " + "usersCompleted int, "
					+ "usersCheckedOut int, " + "PRIMARY KEY (course_id));";
			conn = dataSource.getConnection();
			ps = conn.prepareStatement(sql);
			ps.execute();
	...
	public void initializeStudentTable() {
		...
		try {
			...
			sql = "CREATE TABLE Student ("
					...
					+ "password varchar(30), " + "discipline varchar(30), "
